...
def unpack(imm):
	...
	while i<100:
		...
		if type(priveous_op)!=type(1) and opcode.getResult()=="CMP EAX,EAX" and priveous_op.getResult()=="PUSH EBP":
			jmpAddr=imm.getRegs()['ESP']
...
def main(args):
	...
	imm.log(str(type(sec_entropy_result)))
